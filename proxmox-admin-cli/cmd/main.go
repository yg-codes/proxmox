...
Examples:
  ...
  proxmox-admin-cli quick-start-all --yes`,
...
Examples:
  ...
  proxmox-admin-cli quick-backup-all --storage local-zfs --mode suspend --compress gzip --yes`,
